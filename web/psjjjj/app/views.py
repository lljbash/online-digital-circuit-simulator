		...
		if chip.type=="input":
			for input_unit in activation:
				if str(input_unit['id'])==chip.id:
					chip.activation.initial = input_unit['initial']
					jumps = input_unit['jumping_time']
					jump_num = 0;
					for jump in jumps:
						chip.activation.jumping_time.append(jump)
					chip.activation.repeat = input_unit['repeated']
